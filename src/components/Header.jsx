...
export function NavbarSimple() {
  ...
  return (
    <Navbar className="mx-auto w-full px-4 py-3 lg:px-8 lg:py-2 bg-black bg-opacity-50 backdrop-blur-md fixed top-1 left-0 right-0 z-40">
      <div className="container mx-auto flex items-center justify-between text-black">
        ...
        <div className="flex items-center gap-x-1">
          <Button
            size="sm"
            variant="outlined"
            className="hidden lg:inline-block bg-[--primary-color] text-white border-white"
          >
            <span>Call Now</span>
          </Button>
        </div>
        <IconButton
          variant="text"
          className="ml-auto text-white h-6 w-6 hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden"
          ripple={false}
